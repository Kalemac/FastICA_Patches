...
import org.fastica.math.*;

/**
 * This class computes the Principal Component Analysis
...
/**
 * This constructor computes the Principal Component
 * Analysis of the given set of vectors.
	...
	double[][] inVectors )
{
	...
	System.out.println();
	//System.out.println(Arrays.deepToString(eigenVectors));
...
/**
 * Returns the eigenvalues of the computed covariance
 * matrix.
...
/**
 * Returns the eigenvectors of the computed covariance
 * matrix.
...
/**
 * Returns the computed mean vector for the set of
 * given vectors.
...
/**
 * Returns the set of vectors, which results after
 ...
 */
private static double[] calcMeanValues(
	double[][] inVectors )
{
